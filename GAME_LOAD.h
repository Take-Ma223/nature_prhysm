...
extern void GAME_LOAD(int song_number, int difficulty, NOTE **note, BARLINE *barline, int *lane, int readflag, CALCDIFF *Cdiff, OPTION *Option, BPMC *bpmchange, SC *scrollchange, STOP_SE *stopSequence, int *hash, Song *Music, int *TimetoEndScroll, int *playing_time, CONFIG config,
	double pitch = 1, 
