...
void ShowExtendedStrFit(int x, int y, wchar_t *str, int str_width, int area_width, Config, int color = GetColor(255, 255, 255), int shadow_color = GetColor(0, 0, 0));
void ShowExtendedStrFitToHandle(int x, int y, wchar_t *str, int str_width, int area_width, Config, int FontHandle, int color = GetColor(255, 255, 255), int shadow_color = GetColor(0, 0, 0));
void ShowExtendedStrFitToHandleNoShadow(int x, int y, wchar_t* str, int str_width, int area_width, Config config, int FontHandle, int color = GetColor(255, 255, 255));//領域(area)より大きい文字は縮小して表示する関数(ToHandle版)(影無し)
